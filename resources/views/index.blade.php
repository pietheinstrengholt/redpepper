	...
	<div class="container">
			...
			<div id="intro-header-col-lg-12" class="col-lg-12">
				<div class="intro-message">
					...
					<ul class="list-inline intro-social-buttons">
						<li><a href="<?php echo url('sections'); ?>" class="btn btn-default btn-lg"><span class="network-name"><span style="margin-right:3px;" class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>All regulatory sections</span></a></li>
		...
		<div id="page-content">
			...
			<div class="col-md-3 col-sm-6 hero-feature">
				<div class="thumbnail">
					<div class="caption">
						<h3 class="center"><a href="<?php echo url('sections'); ?>?subject_id=1">COREP</a></h3>
						...
						<p class="p-more-info">
							<a href="<?php echo url('sections'); ?>?subject_id=1" class="btn btn-danger">More info</a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-6 hero-feature">
				<div class="thumbnail">
					<div class="caption">
						<h3 class="center"><a href="<?php echo url('sections'); ?>?subject_id=2">FINREP</a></h3>
						<p class="center">FINREP reporting is a standardized EU-wide framework for reporting financial (accounting) data.<br><br></p>
						<p class="p-more-info">
							<a href="<?php echo url('sections'); ?>?subject_id=2" class="btn btn-primary">More info</a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-6 hero-feature">
				<div class="thumbnail">
					<div class="caption">
						<h3 class="center"><a href="<?php echo url('sections'); ?>?subject_id=3">Liquidity reports</a></h3>
						...
						<p class="p-more-info">
							<a href="<?php echo url('sections'); ?>?subject_id=3" class="btn btn-success">More info</a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-6 hero-feature">
				<div class="thumbnail">
					<div class="caption">
						<h3 class="center"><a href="<?php echo url('sections'); ?>?subject_id=4">Other reports</a></h3>
						...
						<p class="p-more-info">
							<a href="<?php echo url('sections'); ?>?subject_id=4" class="btn btn-warning">More info</a>
						</p>
					</div>
				</div>
			</div>
