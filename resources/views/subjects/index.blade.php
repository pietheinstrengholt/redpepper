...
@section('content')
	...
	<h2>Subjects</h2>
	<h4>Please make a selection of one of the following subjects</h4>

	@if ( !$subjects->count() )
		No subjects found in the database!<br><br>
	@else
		...
		@foreach( $subjects as $subject )
			...
			{!! Form::open(array('class' => 'form-inline', 'method' => 'DELETE', 'route' => array('subjects.destroy', $subject->id), 'onsubmit' => 'return confirm(\'Are you sure to delete this subject?\')')) !!}
			<td>
	...
	<p>
	{!! link_to_route('subjects.create', 'Create Subject') !!}
	</p>
