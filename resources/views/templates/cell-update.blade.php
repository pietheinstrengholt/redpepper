...
@section('content')
	...
	<dd><textarea form="form" name="field_interpretation" class="form-control" rows="5" id="field_interpretation">{!! str_replace('\r\n', PHP_EOL, $field_interpretation['content']) !!}</textarea></dd>
	</dl>

	<dl class="dl-horizontal">
	<dt>Regulation:</dt>
	<dd><textarea form="form" name="field_regulation" class="form-control" rows="5" id="field_regulation">{!! str_replace('\r\n', PHP_EOL, $field_regulation['content']) !!}</textarea></dd>
	</dl>
	...
	<tr>
		<td class="info-left im-content">
			...
			<textarea form="form" name="interpretation_row" class="form-control" rows="6" id="interpretation_row">{!! str_replace('\r\n', PHP_EOL, $interpretation_row['content']) !!}</textarea>
			<h4><b>Regulation:</b></h4>
			<textarea form="form" name="regulation_row" class="form-control" rows="7" id="regulation_row">{!! str_replace('\r\n', PHP_EOL, $regulation_row['content']) !!}</textarea>
		</td>
		<td class="info-right im-content">
			<h4><b>Name:</b></h4>
			<div rows="1" id="colname">{{ $column['column_description'] }}</div>
			<h4><b>Interpretation:</b></h4>
			<textarea form="form" name="interpretation_column" class="form-control" rows="6" id="interpretation_column">{!! str_replace('\r\n', PHP_EOL, $interpretation_column['content']) !!}</textarea>
			<h4><b>Regulation:</b></h4>
			<textarea form="form" name="regulation_column" class="form-control" rows="7" id="regulation_column">{!! str_replace('\r\n', PHP_EOL, $regulation_column['content']) !!}</textarea>
		</td>
	</tr>
	</table>
