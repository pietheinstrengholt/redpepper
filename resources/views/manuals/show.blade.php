...
@section('content')
	...
	<h4 class="tinymce">{!! Format::contentAdjust($section->section_description) !!}</h4>
	<h4 class="tinymce">{!! Format::contentAdjust($section->section_longdesc) !!}</h4><br>
	...
	@else
		@foreach( $templates as $template )
			...
			<h5 class="tinymce">{!! Format::contentAdjust($template->template_longdesc) !!}</h5>
