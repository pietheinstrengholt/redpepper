	...
	<div class="container">
		...
		<div id="page-content" class="row">
			...
			<div class="col-md-3 col-sm-6 hero-feature">
				<div class="thumbnail">
					<div class="caption">
						<h3 class="center"><a href="{{ url('sections') }}?group=corep">COREP</a></h3>
						...
						<p class="p-more-info">
							<a href="{{ url('sections') }}?group=corep" class="btn btn-danger">More info</a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-6 hero-feature">
				<div class="thumbnail">
					<div class="caption">
						<h3 class="center"><a href="{{ url('sections') }}?group=finrep">FINREP</a></h3>
						<p class="center">FINREP reporting is a standardized EU-wide framework for reporting financial (accounting) data.<br><br></p>
						<p class="p-more-info">
							<a href="{{ url('sections') }}?group=finrep" class="btn btn-primary">More info</a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-6 hero-feature">
				<div class="thumbnail">
					<div class="caption">
						<h3 class="center"><a href="{{ url('sections') }}?group=liquidity">Liquidity reports</a></h3>
						...
						<p class="p-more-info">
							<a href="{{ url('sections') }}?group=liquidity" class="btn btn-success">More info</a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-6 hero-feature">
				<div class="thumbnail">
					<div class="caption">
						<h3 class="center"><a href="{{ url('sections') }}?group=other">Other reports</a></h3>
						...
						<p class="p-more-info">
							<a href="{{ url('sections') }}?group=other" class="btn btn-warning">More info</a>
						</p>
					</div>
				</div>
			</div>
